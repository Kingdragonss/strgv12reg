...
if(!['810792899452600333'].some(role => message.member.roles.cache.get(role)) && !message.member.hasPermission('ADMINISTRATOR')) 
...
const tag = '✵'   
const kadınrol = message.guild.roles.cache.find(r => r.id === '810792899435954200') 
const kadınrol2 = message.guild.roles.cache.find(r => r.id === '810792899435954199')
const kayıtsız = message.guild.roles.cache.find(r => r.id === '810792899427827727')
const genelchat = message.guild.channels.cache.find(c => c.id === '810792900136927246')
const savelog = message.guild.channels.cache.find(c => c.id === '810792899570565156')
