      ...
      if(üs) {
        üyesayısı = üyesayısı.replace(/([0-9])/g, d => {
          return {
            ...
            '8': `8`,
            '9': `9`}[d];})}
      const kanal = member.guild.channels.cache.find(r => r.id === "810792899570565157");
      let register = '810792899435954196'
...
client.on("guildMemberAdd", member => {
    ...
    const kytsz = member.guild.roles.cache.find(r => r.id === "810792899427827727") 
     var rol = member.guild.roles.cache.get("810792899562045452") // ŞÜPHELİ HESAP ROLÜNÜN İDSİNİ GİRİN
     var kayıtsız = member.guild.roles.cache.get(810792899427827727) // UNREGİSTER ROLÜNÜN İDSİNİ GİRİN
...
client.on("userUpdate", async (stg, yeni) => {
  var sunucu = client.guilds.cache.get('810792899146416159'); // Buraya Sunucu ID
  var uye = sunucu.members.cache.get(yeni.id);
  var ekipTag = "✵"; // Buraya Ekip Tag
  var ekipRolü = "810792899474227233"; // Buraya Ekip Rolünün ID
  var logKanali = "810792899809116177"; // Loglanacağı Kanalın ID
...
client.on("guildMemberAdd", member => {
  let sunucuid = "810792899146416159"; //Buraya sunucunuzun IDsini yazın
  let tag = "✵"; //Buraya tagınızı yazın
  let rol = "810792899474227233"; //Buraya tag alındığı zaman verilecek rolün IDsini yazın
...
member.roles.add(rol)
  const tagalma = new Discord.MessageEmbed()
      ...
      .setTimestamp()
     client.channels.cache.get('810792899809116177').send(tagalma)
}
})
